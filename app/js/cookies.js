...
$(document).ready(function() {
    ...
    if (!$.cookie('allowCookies') || $.cookie('allowCookies') == 0) {
        ...
        $('body').append('<div id="cookie-wrapper">' +
            ...
            '<div id="cookie-message">Deze website maakt gebruik van cookies om de ervaring te verbeteren.</div>' +
            '<a href="#" id="cookie-accept">Prima!</a>' +
            '<a href="/privacyverklaring" id="cookie-information">Meer informatie</a>' +
            '</div>' +
            '</div>');
